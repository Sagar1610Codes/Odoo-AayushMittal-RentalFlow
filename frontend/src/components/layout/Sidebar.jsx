...
import { Home, Package, ShoppingCart, FileText, Users, Settings, LogOut, Calendar } from 'lucide-react'
...
const Sidebar = () => {
  ...
  const customerMenuItems = [
    ...
    { icon: Calendar, label: 'My Reservations', path: '/dashboard/reservations' },
